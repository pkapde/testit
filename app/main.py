...
def test_page() -> str:
    return """<!doctype html><html><head><title>ContractIQ Validator & Azure OpenAI Classifier</title>
    ...
    </head><body><h1>ContractIQ Document Validator & Azure OpenAI Classifier</h1>
    ...
    <section><h2>Azure OpenAI Document Classifier (POST /api/v1/claims/classification)</h2>
    <form id=aiClassifier><label>Category Type <select id=categoryType required>
    ...
    <script>
    document.querySelector('#aiClassifier').addEventListener('submit',async event=>{
